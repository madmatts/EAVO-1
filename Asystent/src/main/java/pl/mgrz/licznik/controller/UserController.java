...
public class UserController {
	...
	public String submitLogin(@RequestParam String username, @RequestParam String password, Model model, HttpSession session) {

		User test = service.findUser("Matt");
		User user = service.loginUser(username);

		System.out.println("USERNAME: " + test.getUsername());
		System.out.println("CAR: " + test.getCar());
